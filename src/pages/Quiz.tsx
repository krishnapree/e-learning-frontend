...
const Quiz: React.FC = () => {
  ...
  const [answers, setAnswers] = useState<Array<{ questionId: number; isCorrect: boolean }>>([])
  ...
  const completeQuiz = async (finalAnswers: Array<{ questionId: number; isCorrect: boolean }>) => {
    try {
  ...
  if (!quizStarted) {
    return (
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Adaptive Quiz</h1>
        ...
        <div className="card">
          <div className="card-content text-center py-12">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Ready for Your Quiz?</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-8">
          <div className="card">
            <div className="card-content text-center">
              ...
              <p className="text-gray-600 text-sm">Questions tailored to your learning level and weak areas</p>
            </div>
          </div>
          ...
          <div className="card">
            <div className="card-content text-center">
              ...
              <p className="text-gray-600 text-sm">Monitor your improvement over time with detailed analytics</p>
            </div>
          </div>
        ...
        <div className="card">
          <div className="card-content text-center py-12">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-red-600">{answers.length - correctCount}</div>
