...
const StudentCourseMaterials: React.FC = () => {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      ...
      case 'video': return 'fas fa-play-circle text-blue-500'
      case 'document': return 'fas fa-file-word text-blue-600'
      case 'presentation': return 'fas fa-file-powerpoint text-orange-500'
      case 'link': return 'fas fa-external-link-alt text-green-500'
              ...
              <div className="border-b border-gray-200">
                <nav className="-mb-px flex space-x-8">
                  {[
                    ...
                    { key: 'lessons', label: 'Lessons', icon: 'fa-play-circle' }
                  ].map((tab) => (
                    <button
                      key={tab.key}
                    ...
                    <div key={material.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center">
                          <i className={`${getTypeIcon(material.type)} text-2xl mr-3`}></i>
                          <div>
              ...
              <div className="space-y-6">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center mb-2">
                          <h3 className="text-lg font-semibold text-gray-900 mr-3">{lesson.title}</h3>
                          {lesson.completed && (
                        ...
                        <div className="flex items-center mb-4">
                          ...
                          <span className="text-sm text-gray-600">{lesson.progress_percentage}%</span>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          {lesson.materials.map((material) => (
                            <div key={material.id} className="flex items-center p-3 bg-gray-50 rounded-lg">
                              <i className={`${getTypeIcon(material.type)} mr-3`}></i>
                              <div className="flex-1">
                ...
                {lessons.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">Lessons for this course will appear here when they are created.</p>
                  </div>
                )}
              </div>
            )}
