  ...
  const fetchAnalytics = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/courses/${selectedCourse}/analytics?timeRange=${timeRange}`,
        {
          credentials: "include",
        }
      );
      ...
      setAnalyticsData({
        ...
        assignment_performance: [
          ...
          },
          {
            ...
            average_score: 82.1,
            submission_rate: 91.1,
          },
          {
            assignment_name: "Midterm Project",
            average_score: 79.5,
            submission_rate: 86.7,
          },
        ],
      });
    } finally {
        ...
        <div className="mb-6 flex flex-wrap gap-4">
          ...
          <div>
            ...
            <select
              value={timeRange}
              onChange={(e) =>
                setTimeRange(e.target.value as "week" | "month" | "semester")
              }
              className="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="text-2xl font-bold text-green-600">
                  {analyticsData.course_performance[0]?.average_grade?.toFixed(
                    1
                  ) || 0}
                  %
                </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="text-2xl font-bold text-purple-600">
                  {analyticsData.course_performance[0]?.completion_rate?.toFixed(
                    1
                  ) || 0}
                  %
                </div>
